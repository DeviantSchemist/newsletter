  ...
  return (
    <form className="flex flex-col mt-[40px] font-Roberto">
      ...
      <div className="rounded-lg border border-[#19182b]/25 mb-[24px]">
        <input value={props.value} onChange={props.handleChange} className="rounded-lg text-base text-left text-[#242742] pt-[16px] pb-[16px] pl-[24px] w-full" placeholder="email@company.com" />
      </div>
